...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@yogamaster-project.lacfd.mongodb.net/?retryWrites=true&w=majority&appName=yogamaster-project`;
